...
FastClick.prototype.touchHasMoved = function (a) {
  ...
  return Math.abs(a.pageX - this.touchStartX) > b ||
    Math.abs(a.pageY - this.touchStartY) > b
    ? !0
    : !1;
};
...
FastClick.prototype.onMouse = function (a) {
  return this.targetElement && !a.forwardedTouchEvent && a.cancelable
...
(function () {
  ...
  var N = (T.each = T.forEach = function (e, t, r) {
    ...
    if (h && e.forEach === h) e.forEach(t, r);
      ...
      for (var o in e) if (T.has(e, o) && t.call(r, e[o], o, e) === n) return;
  });
  ...
  (T.isEqual = function (e, t) {
    ...
    (T.random = function (e, t) {
      return (
        t == null && ((t = e), (e = 0)), e + (0 | (Math.random() * (t - e + 1)))
      );
    });
  var _ = {
    escape: {
